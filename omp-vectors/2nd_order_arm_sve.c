...
int *thread_id;   // Track thread being used
...
void Allocate_and_Init_Memory() {
    ...
    // Thread
    posix_memalign((void**)&thread_id, alignment, N*sizeof(int));
...
void Compute_U_from_P(int tid) {
    // Compute the number of bytes
    // Number of vectors depends on the number of OMP threads
    int cells_per_omp_thread = (int)(N/OMP_THREADS);
    int no_vectors = (int)(cells_per_omp_thread/4);
    ...
    for (int vector = 0; vector < no_vectors; vector++) {
        int sve_index = tid*cells_per_omp_thread + vector*4;
        // Now we can point our sve float types at these temp pointers
        vec_p0 = (svfloat32_t*)((float*)p0+sve_index); vec_p1 = (svfloat32_t*)((float*)p1+sve_index);
        vec_p2 = (svfloat32_t*)((float*)p2+sve_index); vec_p3 = (svfloat32_t*)((float*)p3+sve_index);
        vec_u0 = (svfloat32_t*)((float*)u0+sve_index); vec_u1 = (svfloat32_t*)((float*)u1+sve_index);
        vec_u2 = (svfloat32_t*)((float*)u2+sve_index); vec_u3 = (svfloat32_t*)((float*)u3+sve_index);
...
void Update_U_from_F(int tid) {
    ...
    // This loop we share across OMP threads
    #pragma omp for
    for (int i = 0; i < NX; i++) {
        for (int j = 0; j < NY; j++) {
            int index = i*NX + j;
    ...
    for (int vector = 0; vector < no_vectors; vector++) {
        sve_index = tid*cells_per_omp_thread + vector*4;
        // Map SVE pointers onto their respective floating point arrays
        vec_u0 = (svfloat32_t*)((float*)u0+sve_index); vec_u1 = (svfloat32_t*)((float*)u1+sve_index);
        vec_u2 = (svfloat32_t*)((float*)u2+sve_index); vec_u3 = (svfloat32_t*)((float*)u3+sve_index);
        vec_fp0 = (svfloat32_t*)((float*)fp0+sve_index); vec_fp1 = (svfloat32_t*)((float*)fp1+sve_index);
        vec_fp2 = (svfloat32_t*)((float*)fp2+sve_index); vec_fp3 = (svfloat32_t*)((float*)fp3+sve_index);
        vec_fm0 = (svfloat32_t*)((float*)fm0+sve_index); vec_fm1 = (svfloat32_t*)((float*)fm1+sve_index);
        vec_fm2 = (svfloat32_t*)((float*)fm2+sve_index); vec_fm3 = (svfloat32_t*)((float*)fm3+sve_index);
        vec_hp0 = (svfloat32_t*)((float*)hp0+sve_index); vec_hp1 = (svfloat32_t*)((float*)hp1+sve_index);
        vec_hp2 = (svfloat32_t*)((float*)hp2+sve_index); vec_hp3 = (svfloat32_t*)((float*)hp3+sve_index);
        vec_hm0 = (svfloat32_t*)((float*)hm0+sve_index); vec_hm1 = (svfloat32_t*)((float*)hm1+sve_index);
        vec_hm2 = (svfloat32_t*)((float*)hm2+sve_index); vec_hm3 = (svfloat32_t*)((float*)hm3+sve_index);
        vec_fR0 = (svfloat32_t*)((float*)Right_f0+sve_index); vec_fR1 = (svfloat32_t*)((float*)Right_f1+sve_index);
        vec_fR2 = (svfloat32_t*)((float*)Right_f2+sve_index); vec_fR3 = (svfloat32_t*)((float*)Right_f3+sve_index);
        vec_fL0 = (svfloat32_t*)((float*)Left_f0+sve_index); vec_fL1 = (svfloat32_t*)((float*)Left_f1+sve_index);
        vec_fL2 = (svfloat32_t*)((float*)Left_f2+sve_index); vec_fL3 = (svfloat32_t*)((float*)Left_f3+sve_index);
        vec_fT0 = (svfloat32_t*)((float*)Top_f0+sve_index); vec_fT1 = (svfloat32_t*)((float*)Top_f1+sve_index);
        vec_fT2 = (svfloat32_t*)((float*)Top_f2+sve_index); vec_fT3 = (svfloat32_t*)((float*)Top_f3+sve_index);
        vec_fB0 = (svfloat32_t*)((float*)Bottom_f0+sve_index); vec_fB1 = (svfloat32_t*)((float*)Bottom_f1+sve_index);
        vec_fB2 = (svfloat32_t*)((float*)Bottom_f2+sve_index); vec_fB3 = (svfloat32_t*)((float*)Bottom_f3+sve_index);
        // 2nd order
        vec_dfp0 = (svfloat32_t*)((float*)dfp0+sve_index); vec_dfp1 = (svfloat32_t*)((float*)dfp1+sve_index);
        vec_dfp2 = (svfloat32_t*)((float*)dfp2+sve_index); vec_dfp3 = (svfloat32_t*)((float*)dfp3+sve_index);
        vec_dfm0 = (svfloat32_t*)((float*)dfm0+sve_index); vec_dfm1 = (svfloat32_t*)((float*)dfm1+sve_index);
        vec_dfm2 = (svfloat32_t*)((float*)dfm2+sve_index); vec_dfm3 = (svfloat32_t*)((float*)dfm3+sve_index);
        vec_dhp0 = (svfloat32_t*)((float*)dhp0+sve_index); vec_dhp1 = (svfloat32_t*)((float*)dhp1+sve_index);
        vec_dhp2 = (svfloat32_t*)((float*)dhp2+sve_index); vec_dhp3 = (svfloat32_t*)((float*)dhp3+sve_index);
        vec_dhm0 = (svfloat32_t*)((float*)dhm0+sve_index); vec_dhm1 = (svfloat32_t*)((float*)dhm1+sve_index);
        vec_dhm2 = (svfloat32_t*)((float*)dhm2+sve_index); vec_dhm3 = (svfloat32_t*)((float*)dhm3+sve_index);

        vec_dfR0 = (svfloat32_t*)((float*)Right_df0+sve_index); vec_dfR1 = (svfloat32_t*)((float*)Right_df1+sve_index);
        vec_dfR2 = (svfloat32_t*)((float*)Right_df2+sve_index); vec_dfR3 = (svfloat32_t*)((float*)Right_df3+sve_index);
        vec_dfL0 = (svfloat32_t*)((float*)Left_df0+sve_index); vec_dfL1 = (svfloat32_t*)((float*)Left_df1+sve_index);
        vec_dfL2 = (svfloat32_t*)((float*)Left_df2+sve_index); vec_dfL3 = (svfloat32_t*)((float*)Left_df3+sve_index);
        vec_dfT0 = (svfloat32_t*)((float*)Top_df0+sve_index); vec_dfT1 = (svfloat32_t*)((float*)Top_df1+sve_index);
        vec_dfT2 = (svfloat32_t*)((float*)Top_df2+sve_index); vec_dfT3 = (svfloat32_t*)((float*)Top_df3+sve_index);
        vec_dfB0 = (svfloat32_t*)((float*)Bottom_df0+sve_index); vec_dfB1 = (svfloat32_t*)((float*)Bottom_df1+sve_index);
        vec_dfB2 = (svfloat32_t*)((float*)Bottom_df2+sve_index); vec_dfB3 = (svfloat32_t*)((float*)Bottom_df3+sve_index);
...
void Compute_F_from_P(int tid) {
    ...
    // These for loops are not shared; each thread executes over a smaller region
    // independently; we use the thread_id to manage access to SVE variables.
    for (int vector = 0; vector < no_vectors; vector++) {
        sve_index = tid*cells_per_omp_thread + vector*4;
        // Now we can point our sve float types at these temp pointers
        ...
        vec_hm0 = (svfloat32_t*)((float*)hm0+sve_index); vec_hm1 = (svfloat32_t*)((float*)hm1+sve_index);
        vec_hm2 = (svfloat32_t*)((float*)hm2+sve_index); vec_hm3 = (svfloat32_t*)((float*)hm3+sve_index);
        vec_f0 = (svfloat32_t*)((float*)f0+sve_index); vec_f1 = (svfloat32_t*)((float*)f1+sve_index);
        vec_f2 = (svfloat32_t*)((float*)f2+sve_index); vec_f3 = (svfloat32_t*)((float*)f3+sve_index);
        vec_h0 = (svfloat32_t*)((float*)h0+sve_index); vec_h1 = (svfloat32_t*)((float*)h1+sve_index);
        vec_h2 = (svfloat32_t*)((float*)h2+sve_index); vec_h3 = (svfloat32_t*)((float*)h3+sve_index);
        vec_a = (svfloat32_t*)((float*)a+sve_index);
...
void Save_Results() {
    ...
    for (i = 0; i < NX; i++) {
        for (j = 0; j < NY; j++) {
            cx = (i+0.5)*DX;
            cy = (j+0.5)*DY;
            fprintf(fptr, "%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\n", cx, cy, p0[index], p1[index], p2[index], p3[index], u0[index], u1[index], u2[index], u3[index]);
            index++;
        }
    }
    // Close the file
